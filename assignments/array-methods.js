...
//   allCaps = runner.first_name.toUpperCase();
//   return allCaps;
// })
...
// Problem 1
let emailList = runners.map( runner => runner.email.toLocaleLowerCase())
console.log(emailList);


// Problem 2
const prize = runners.filter( runner => runner.donation > 200);
console.log(prize);

const prizeEmails = prize.map( runners => runners.email);
console.log(prizeEmails);

// Problem 3
let priceAverage = runners.reduce ((total, current) => {
  return total += current.donation;
}, 0)

console.log(priceAverage / (runners.length - 1))
